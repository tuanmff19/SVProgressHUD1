...
@property (strong, nonatomic) UIView *customIndefinitedAnimationView;		    	        // default is nil
@property (strong, nonatomic) UIView *customProgressAnimationView;			    			// default is nil
@property (strong, nonatomic) UIView *customInfoView;						    			// default is nil
@property (strong, nonatomic) UIView *customSuccessView;						    		// default is nil
@property (strong, nonatomic) UIView *customErrorView;						    			// default is nil
...
+ (void)setCustomIndefinitedAnimationView:(UIView*)view;		    // default is nil
+ (void)setCustomProgressAnimationView:(UIView*)view;			    // default is nil
+ (void)setCustomInfoView:(UIView*)view;                 			// default is nil
+ (void)setCustomSuccessView:(UIView*)view;                 		// default is nil
+ (void)setCustomErrorView:(UIView*)view;                 			// default is nil
